...
include(":feature:search:search_screen")
include(":core:di")
include(":feature:search:search_repo")
include(":feature:authentication:auth_repo")
include(":feature:authentication:login")
include(":feature:authentication:register")
include(":feature:authentication:reset")
include(":core:identity-api")
include(":core:identity-google")
include(":core:ui")
